...
//This ordered list contains a move and copy constructor
//These constructors ensure that the repopulating deck method works properly
...
public:
	...
	OrderedList(const OrderedList<T, Order> &src);
	OrderedList(OrderedList<T, Order> &&other);
	OrderedList<T, Order> &operator=(const OrderedList<T, Order> &src);
	OrderedList<T, Order> &operator=(OrderedList<T, Order> &&src);
...
OrderedList<T, Order>::OrderedList(unsigned int capacity) :
	m_container(capacity)
{}

template <class T, class Order>
OrderedList<T, Order>::OrderedList(const OrderedList<T, Order> &src) :
	m_container(src.m_container)
{}

template <class T, class Order>
OrderedList<T, Order> &OrderedList<T, Order>::operator=(const OrderedList<T, Order> &src)
{
	if (&src != this)
		m_container = src.m_container;
...
template <class T, class Order>
OrderedList<T, Order>::OrderedList(OrderedList<T, Order> &&other) :
	m_container(std::move(other.m_container))
{}

template <class T, class Order>
OrderedList<T, Order> &OrderedList<T, Order>::operator=(OrderedList<T, Order> &&src)
{
	std::swap(m_container, src.m_container);
